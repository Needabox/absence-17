...
<body class="dark:bg-gray-900 bg-white">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="https://smksedkijakarta.wordpress.com/wp-content/uploads/2017/11/smkn-17-jakarta.jpg" class="h-8 me-3" alt="FlowBite Logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SMKN 17 JAKARTA</span>
                    </a>
                </div>
    ...
    <div class="p-4 sm:ml-64 dark:bg-gray-900 bg-white">
        <div class="p-4 border border-gray-200 rounded-lg dark:border-gray-700 dark:bg-gray-900 bg-white mt-14">
