...
<div class="p-4 sm:ml-64 dark:bg-gray-900 bg-white">
    <div class="flex items-center mt-16">
        <a href="{{ route('majors.index') }}" class="p-2 rounded-lg border border-gray-300 shadow-sm dark:border-gray-700">
        ...
        <h1 class="text-3xl font-semibold text-gray-900 dark:text-white ml-5">Edit Major</h1>
    </div>
