...
<div class="p-4 sm:ml-64 dark:bg-gray-900 bg-white">
    <div class="flex items-center mt-16">
        ...
        <h1 class="text-3xl font-semibold text-gray-900 dark:text-white ml-5">Edit User</h1>
    </div>
    ...
    <div class="p-4 border border-gray-200 rounded-lg dark:border-gray-700 dark:bg-gray-900 bg-white mt-3">
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2">
                ...
                <div>
                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password <span class="text-sm text-gray-400">(Kosongkan jika tidak diubah)</span></label>
                ...
                <div>
                    ...
                    <select id="class_id" name="class_id"
                        ...
                        <option value="{{ $cls->id }}" {{ $cls->id == $user->class_id ? 'selected' : '' }}>
                            {{ $cls->name }}
                        </option>
                        @endforeach
                    </select>
