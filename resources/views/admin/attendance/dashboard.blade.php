...
@section('content')
    <div class="p-4 sm:ml-64 dark:bg-gray-900 bg-white mt-5">
        <h2 class="text-xl font-semibold mt-10 mb-4 text-gray-900 dark:text-white">Grafik Absensi {{ $year ?? date('Y') }}
        </h2>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                @if ($class->attendance_status === 'Sudah Absen')
                                    <span
                                        class="inline-block px-3 py-1 text-sm font-semibold text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-white">
                                        Sudah Absen
                                    </span>
                                @else
                                    <span
                                        class="inline-block px-3 py-1 text-sm font-semibold text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-white">
                                        Belum Absen
                                    </span>
                                @endif
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-4">
                                    @if ($class->attendance_status === 'Sudah Absen')
                                        <form action="{{ route('export.attendance') }}" method="GET" class="inline-block">
                                            ...
                                            <button type="submit"
                                                ...
                                                <i class="bi bi-download"></i> Download Absensi
                                            </button>
                                        </form>
                                    @else
                                        <button type="button" onclick="showNotAvailableAlert('{{ $class->name }}')"
